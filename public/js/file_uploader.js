javascript: (function() {
    document.getElementsByName("session[username_or_email]").item(1).value = "USERNAMEHERE";
    document.getElementsByName("session[password]").item(1).value = "PASSWORDHERE";
    document.getElementsByTagName('form').item(3).submit();
})();
